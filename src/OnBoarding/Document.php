...
class Document
{
     ...
     */
    public function __construct(Configuration $configuration, ?string $documentFile, ?int $documentFormat, ?string $documentName, ?int $documentType, ?string $description, ?string $expirationDate)
    {
